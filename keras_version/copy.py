...
if __name__=='__main__':
    ...
    app.build_network(is_training=True,max_vocab_len=50000,hierarchical=True,context_max_len=11)
    # app.train(batch_size=16,train_data_path='../Data/train_3.txt',union=True,hierarchical=True,
    #           depth=2,dropout=0.3,mode=2,predict_model_path='models/nonebatch_unionseq2seq-004--0.99970--1.00288.hdf5',
